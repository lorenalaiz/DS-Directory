...
/* Shared piece of the Google Places autocomplete flows — Professionals (f-endereco,
   full address) and Families (ff-suburb, suburb-only) both need a Places API session
   token, the only genuinely shared logic between them. */
